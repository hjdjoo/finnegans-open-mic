      ...
      <div className={clsx(
        ...
        <div className="relative mx-2 flex items-center">
          ...
          <div className="flex grow-1 items-center justify-end bg-dark-bg/50 rounded-lg">
            <div className="flex ml-1 md:ml-2 my-auto items-center justify-between bg-dark-bg/50 rounded-lg">
              <span className="text-gray-300 text-xs md:text-lg">{status.active ? "Yes" : "No"}{`, we are`}</span>
              <span className={clsx(
                'font-bold text-xs md:text-lg ml-1 md:ml-2',
          ...
          {status.message && (
            <div className="flex ml-1 md:ml-2 grow-1 justify-end">
                <div className="bg-irish-green/10 border border-irish-green/30 rounded-lg">
